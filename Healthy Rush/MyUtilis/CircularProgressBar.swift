...
//  Healthy Rush
//
//  Created by Luigi Loria on 12/06/21.
//
...
public class CircularProgressBar: SKNode {
    ...
    private let valueLabel = SKLabelNode(text: "0 %")
    ...
    public var value: Double {
        didSet {
            ...
            circleNode.path = UIBezierPath(
                ...
                radius: radius * 2,
                startAngle: CGFloat(90).degreesToRadiants(),
                endAngle: CGFloat(90 - 360 * value / 100).degreesToRadiants(),
                clockwise: false)
                .cgPath
        }
    }
